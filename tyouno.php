<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="container">
          ...
          <!-- 級別 -->
            <div id="title"><a id="top"></a>超能力者</div>
          ...
          <!-- 解說 -->
            <div id="description">
                ...
                <h2>
                	異能──<BR>
        			借助魔的力量、不利用魔術迴路、也不是超越種，僅以人類之力所引發出的異常現象。 與魔術不同，先天的才能是必要的。持有異能者，如呼吸一般引起超常現象，對本人來說這是理所當然的事情，在外部（一般常識）指出後才意識到自己是異常的。 <BR>
       				那麼，你是為了什麼而使用那份力量呢？ <BR>
                </h2> 
            </div>
            ...
            <div id="description">
                ...
                <h2>初期取得：<br>從「一代變異」「血脈」中選一，而後再選擇一個自己喜歡的特技。</h2> 
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">未持有「血脈」</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">未持有「一代變異」</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>你每扣掉Ｎ點體力或是情緒值，就可以將同等戰鬥數值數值強化到他人身上。此數值不得超過你的【超能力者】級別。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>一戰鬥一次。在一回合內可以使用精神代替行動、近戰、射擊判定。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>選取一個你擁有的特技，將其內文數值+3，一個劇本只能使用三次。特技有疑慮問題由GM判定。 <BR>
            ...
            <div id="description">
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">阿賴耶識的抑止力</h3>
                        ...
                        <!-- 特技設定 -->                    
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">超能力者等級四以上</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">超能力者等級五以上</div>
                            <br/>
                        
                        <!-- 特技解說 -->
                        
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>你可以在任何時間點，使自己的HP上限剩下1。在場景結束前可以取得其他級別的任兩個特技(如果有取得條件，則必須滿足)並使用。場景結束前，你的判定增加你的【超能力者等級】。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 代價 -->
                            <div class="skillTh clear">代價</div><div class="skillTd" style="width:265px;">最大生命力／２</div>
                            <br/>
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">創造角色時限定獲得</div>
                            <br/>
                        
                        <!-- 特技解說 -->
                        
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>你可以取得其他級別任何非額外技能的特技２個。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 代價 -->
                            <div class="skillTh clear">代價</div><div class="skillTd" style="width:265px;">傷害代價10點</div>
                            <br/>
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>一劇本可以使用【超能力者等級-2】次。從以下效果擇一發動：</p>
                            <!-- 分隔線 -->
                            <hr class="skillHr"/>
                            <!-- 次効果 -->
                            <p class="skillFunction">
                            	►你瞬間離開目前所在場景，但無法控制會移動到哪。 <BR>
                                ►指定一對象的判定減少2D6點。 <BR>
                                ►指定一對象的判定增加1D6點。 <BR>
                                ►指定一對象的不良狀態隨機消失一種。 <BR>
                                ►指定對象的情緒點上升【你的超能力者等級】D6。 <BR>
                            </p>
                        <!-- 結尾 -->  
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <br/>
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">超能力者等級六以上</div>
                            <br/>
                        
                        <!-- 特技解說 -->
                        
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>一劇本【超能力者等級-5】次。你能短暫地看到生物的生之線。戰鬥中使用時，在戰鬥結束前，你的攻擊傷害增加對象最大生命值的五分之一。</p>

                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>
                            當你受到來自同區域的傷害後，你可以無視行動狀態，以對手為對象進行攻擊，第一次承受這技能造成反擊的對手無法迴避，第二次以後須受到迴避達成值－４的懲罰。
                            </p>
                        <!-- 結尾 -->     
                    </div>
                </skillbox>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>
                            	跳躍切砍的劍技，傷害追加１Ｄ６，另外，攻擊後你可以無視阻礙，移動到其他區域。
                            </p>
                        <!-- 結尾 -->     
                    </div>
                </skillbox>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>
                            以飛鳥為底，發展到最終形式的一刀流劍技，此次傷害追加《３》Ｄ６＋《３》，命中達成值＋《３》。另外，攻擊後你可以無視阻礙移動。
                            </p>
                        <!-- 結尾 -->     
                    </div>
                </skillbox>
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>
                            你的傷害追加《你的劍士等級》Ｄ６，攻擊射程成為全區域。獲得此技能後不需支付代價也有常時效果──你不會被［你的劍士等級］以下的角色奇襲成功，即便你在睡覺中遇襲，身體也能自動擺出架式應戰。你在準備階段能夠使用所有的一刀流起手架式效果。
                            </p>
                        <!-- 結尾 -->     
                    </div>
                </skillbox>

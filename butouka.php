    ...
    <div id="description">
        ...
        <skillbox>
            <div class="skillWrap">
                ...
                <!-- 效果 -->
                <p class="skillFunction"><b>効果：</b>實際傷害後效果，對手的情緒值減去同等傷害骰的數值。</p>
        ...
        <skillbox>
            <div class="skillWrap">
                ...
                <p class="skillFunction"><b>効果：</b>
                    你將現有HP與TP加總後均分。 <BR>
                    均分後的HP每高過最大HP5點，獲得1點【真氣】。 <BR>
                    每1點真氣提升你1D6的傷害，並視為額外的生命值，當你受到傷害時，優先扣除真氣。
                </p>
    ...
    <div id="description">
        ...
        <skillbox>
            <div class="skillWrap">
                ...
                <!-- 代價 -->
                <div class="skillTh clear">代價</div><div class="skillTd" style="width:265px;">1點真氣</div>
                <br/>
                ...
                <!-- 效果 -->
                <p class="skillFunction"><b>効果：</b>
                    命中後效果，選擇本次攻擊中尚未使用的攻擊類型／近戰技能，視同直接命中。 <BR>
                    並將傷害分段計算後加總。
                </p>
        ...
        <skillbox>
            <div class="skillWrap">
                ...
                <p class="skillFunction"><b>効果：</b>
                    ...
                    回合結束前你的被動判定減少1D6，受到攻擊時傷害額外增加2D6。 <BR>
                    結束階段你獲得1真氣。
                </p>
        ...
        <skillbox>
            <div class="skillWrap">
                ...
                <!-- 效果 -->
                <p class="skillFunction"><b>効果：</b>
                    受到近戰攻擊時可使用，本次的迴避判定增加1D6。 <BR>
                    迴避成功時，選擇一攻擊類型／近戰攻擊對手，並無須擲骰直接命中。
                </p>

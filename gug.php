<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="container">
          ...
          <!-- 級別 -->
            <div id="title"><a id="top"></a>異端</div>
          ...
          <!-- 解說 -->
            <div id="description">
                ...
                <h2>所謂的異端，就是包含魔術在內的此世常識，以某種形式跨越的非常識者。<br>
					別人看到你的話，也許會嘲笑、也許會畏懼──<br>
					但是，不管你是用何種形式掌握──你確實有著顛覆此世常識的力量。</h2> 
            </div>
            ...
            <div id="description">
                ...
                <h2>初期取得：<br>得到「架空存在」、或是「理外存在」。</h2> 
                <h2>升級：<br>每當等級是2的倍數時，你可以取得兩個特技。當等級是三等、七等時，你可以取得一個特技</h2>
            </div>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>你的【生命力】與【集中力】+12。</p>
		...
		<hr class="description"/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>傷害+《1D6》，此攻擊成為概念武裝。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>任何人判定時使用，對象達成值-《1D6》，使用後自己行動值減少1D6。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>對自己使用，情緒值+《1D6》。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>對一人使用。<br>
			    到戰鬥結束為止，戰鬥能力值選一項+《1D6》。但是，受到使用的對象將每回合結束時受到《1D6》的實際傷害。<br>
                此效果可以累加。<br>
			    對象如要抵抗，以精神骰判定。</p>
			    ...
			    這個特技宣言後，下一個所使用的特技的攻擊對象數會擴大1D6。但是，丟出6的話等同於0。<br>
			    另外丟出的數目也一定得全部選完對象。不選的話，必須受到「沒有選擇人數」點的無視防禦實際傷害。</p>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>以你自己為對象， 每回合結束時HP跟情緒值+《1D6》。</p>
            ...
            <div id="description">
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">也許會有這種好事</h3>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">異端LV5以上</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">毫無迷惑的殺戮</h3>
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">"虛數破壞"、"三稜鏡之骰"、"戲謔者"之取得</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>以你自己為對象。該回合行動點與傷害增加《4D6》。</p>

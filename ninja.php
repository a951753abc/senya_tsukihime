<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="container">
          ...
          <!-- 級別 -->
            <div id="title"><a id="top"></a>忍者</div>
          ...
          <!-- 解說 -->
            <div id="description">
                ...
                <h2>忍者──與魔術師一樣為活動在歷史背後的「影」。你是接受指示，只為任務與命令而活的存在。</h2> 
            </div>
		...
		<hr class="description"/>
                ...
                <!-- 特技框架 -->
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 分類 -->
                            <div class="skillTh clear">分類</div><div class="skillTd" style="width:265px;">進攻／遠戰</div>
                            <br/>
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">中忍</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">忍術‧自在變化</h3>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技解說 -->
                            ...
                            <!-- 效果 -->
                            <p class="skillFunction"><b>効果：</b>你進入「潛行」狀態。每次輪到你行動時，需與其他人進行潛行判定(GM視狀況決定雙方使用何種能力判定)，對象判定失敗時，你對對象的迴避與命中增加《你的忍者等級》。
                            </p>
		...
		<skillbox>
                    <div class="skillWrap_dividepoint">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3" style="width:590px;">土之道、水之道、火之道、風之道</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">秘忍術‧闇蜘蛛</h3>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">持有忍具「忍捲」、中忍</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">秘忍術‧咒禁封靈</h3>
                        ...
                        <!-- 特技設定 -->
                            ...
                            <!-- 取得限制 -->
                            <div class="skillTh2">取得限制</div><div class="skillTd3">上忍</div>
                            <br/>
                ...
                <skillbox>
                    <div class="skillWrap">
                        ...
                        <!-- 特技名稱 -->
                        <h3 class="skillTitle">秘忍術‧八門煉化</h3>
